...
@section('title', 'Admin Login - Gestão Empresarial')
            ...
            <div class="col-md-5">
                <div class="card login-card border-0">
                    ...
                    <div class="card-body p-5">
                        <form method="POST" action="{{ route('admin.login.fake') }}">
                            @csrf
                            ...
                            <button type="submit" class="btn btn-primary-custom w-100 py-2 fw-semibold">
                                <i class="bi bi-shield-lock me-2"></i>Acessar Painel
                            </button>
                        </form>

                        <div class="text-center mt-4">
                            <a href="{{ route('login') }}" class="text-azul-marinho text-decoration-none">
                                <i class="bi bi-arrow-left me-1"></i>Voltar para login comum
                            </a>
                        </div>
                    </div>
                </div>
